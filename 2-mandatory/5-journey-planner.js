...
*/
function isAccessibleByTransportMode(arrayIsFirst,stringIsSecond) {
return arrayIsFirst.includes(stringIsSecond);
...
function journeyPlanner(locations, transportMode) {
  return myJourney = locations.filter(item => item.includes(transportMode)).map(item => item[0])
